...
class StudentTest < Minitest::Test
  def setup
    @valid_date = '2002-04-10'
    @student = Student.new('Kopyl', 'Maksym', @valid_date)
  end


  def test_initialize
    assert_equal 'Kopyl', @student.surname
    assert_equal 'Maksym', @student.name
  ...
  def test_equality
    same_student = Student.new('Kopyl', 'Maksym', @valid_date)
    different_student = Student.new('Poroh', 'Petro', '2001-09-11')
  ...
  def test_invalid_date_format
    assert_raises(ArgumentError) { Student.new('Kopyl', 'Maksym', '10/04/2002') }
  end


  def test_future_date
    future_date = (Date.today + 1).to_s
    assert_raises(ArgumentError) { Student.new('Kopyl', 'Maksym', future_date) }
  end
  ...
  def test_birthdate_on_boundary
    boundary_student = Student.new('Synelnyk', 'Daniil', '2000-12-31')
