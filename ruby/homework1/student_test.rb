...
def test_student_initialization
  student = Student.new("Synelnyk", "Daniil", "02-09-2006")
  
  raise "Test failed: Incorrect surname" if !student.surname == "Synelnyk"
  raise "Test failed: Incorrect name" if !student.name == "Daniil"
  raise "Test failed: Incorrect date_of_birth" if student.date_of_birth != {"day" => 2, "month" => 9, "year" => 2006}
...
def test_invalid_date_format
  ...
  begin
    Student.new("Synelnyk", "Daniil", "02/09/2006")
...
def test_future_date_of_birth
  ...
  begin
    Student.new("Synelnyk", "Daniil", "02-09-2025")
...
def test_get_students_by_name
  ...
  student = Student.new("Synelnyk", "Daniil", "02-09-2006")
  raise "Test failed: Incorrect students by name" if !Student.get_students_by_name("Daniil").include?(student)
